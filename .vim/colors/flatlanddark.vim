" Vim color file
" Converted from Textmate theme FlatlandDark using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
let g:colors_name = "FlatlandDark"
...
hi String ctermfg=189 ctermbg=NONE cterm=NONE guifg=#c4e2f2 guibg=NONE gui=NONE
